<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="frmReceiveBalance.aspx.cs" Inherits="BusinessManagementSystem.frmReceiveBalance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Customers Payments</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="Default.aspx">Dashboard</a></li>
                        <li class="breadcrumb-item active">Customers Payments</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <ContentTemplate>
                                        <div class="row">
                                            <div class="col-md-6 my-2">
                                                <asp:DropDownList ID="customerDDL" CssClass="form-control" AutoPostBack="true" AppendDataBoundItems="true" OnSelectedIndexChanged="customerDDL_SelectedIndexChanged" runat="server">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 my-2">
                                                <asp:TextBox ID="receivedTxt" CssClass="form-control" placeholder="Received Balance" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 my-2">
                            ...
                            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="LabelName" Text='<%# Eval("Customer") %>' runat="server" />
                                        </td>
                                        <td>
                                            <asp:Label ID="LabelPhone" Text='<%# Convert.ToDateTime(Eval("Date")).ToString("dd-MM-yyyy") %>' runat="server" />
                                        </td>
                                        <td>
                                            <asp:Label ID="LabelAddress" Text='<%# Eval("Previous Balance") %>' runat="server" />
                                        </td>
                                        <td>
                                            <asp:Label ID="LabelOpeningBalance" Text='<%# Eval("Received Balance") %>' runat="server" />
                                        </td>
                                        <td>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 my-2">
                                    <asp:DropDownList ID="customerDDL2" CssClass="form-control" AutoPostBack="true" AppendDataBoundItems="true" runat="server">
                                        <asp:ListItem>Select Customer</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-6 my-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 my-2">
                                    <asp:TextBox ID="receivedTxt2" CssClass="form-control" placeholder="Received Balance" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 my-2">
