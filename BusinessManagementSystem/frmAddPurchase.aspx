<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="frmAddPurchase.aspx.cs" Inherits="BusinessManagementSystem.frmAddPurchase" %>
            ...
            <div class="invoice p-3 mb-3">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <asp:Label Text="Supplier:" runat="server" />
                                <asp:DropDownList ID="supplierDDL" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="true" runat="server" OnSelectedIndexChanged="supplierDDL_SelectedIndexChanged">
                            ...
                            <div class="col-md-2">
                                <asp:Label Text="NTN No:" runat="server" />
                                <asp:TextBox ID="ntnTxt" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-2">
                                <asp:Label Text="Batch ID:" runat="server" />
                                <asp:TextBox ID="batchTxt" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <asp:TextBox ID="expiryTxt" CssClass="form-control" TextMode="Date" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                                <br />
