<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="frmViewPurchase.aspx.cs" Inherits="BusinessManagementSystem.frmViewPurchase" %>
                            ...
                            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("Supplier") %>'></asp:Label>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("Cash Paid") %>'></asp:Label>
                                        </td>
                                        <td>
