<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="frmSupplierRemaining.aspx.cs" Inherits="BusinessManagementSystem.frmSupplierRemaining" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Supplier Balance</h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <asp:Repeater ID="Repeater1" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("NTN No:") %>'></asp:Label>
                                        </td>
                                        <td>
